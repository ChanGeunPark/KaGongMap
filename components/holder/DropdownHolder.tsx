...
function DropDownItem({ cafes, onSelect }: DropDownItemProps) {
  return (
    <div className="absolute left-0 right-0 top-[calc(100%+8px)] z-50 max-h-[60vh] overflow-y-auto kg-scroll rounded-md border border-border-medium bg-white shadow-overlay">
      {cafes.length === 0 ? (
