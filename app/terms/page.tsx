...
const sections = [
  ...
  },
  {
    title: "10. 회원 탈퇴",
    body: [
      "회원은 마이페이지에서 카공맵 계정 탈퇴를 요청할 수 있습니다.",
      "탈퇴 시 계정 정보, 즐겨찾기, 로그인 기반 좋아요, 푸시 토큰 등 개인 데이터는 삭제됩니다.",
      "카페 제보, 사진 제보, 정보 수정 제안 등 서비스 운영에 필요한 기록은 개인 식별자를 제거하거나 익명화한 뒤 보관될 수 있습니다.",
      "탈퇴 후 같은 소셜 계정으로 다시 로그인하면 신규 계정으로 다시 생성될 수 있습니다.",
    ],
  },
  {
    title: "11. 지식재산권",
  ...
  },
  {
    title: "14. 문의",
    body: [
      "서비스 이용, 신고, 콘텐츠 삭제, 계정 관련 문의는 앱의 문의하기 페이지를 통해 접수할 수 있습니다.",
      "문의 채널이 변경되는 경우 본 약관에 반영합니다.",
    ],
  },
];
