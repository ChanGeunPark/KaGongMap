...
- **비로그인 가능**: 지도 탐색, 카페 상세·태그 열람, 후기 읽기, 필터 검색
- **로그인 필요**: 카페 등록, 후기 작성, 즐겨찾기, 카페 정보 수정 제안, 마이페이지
...
## 핵심 카공 태그 (enum)
```
콘센트_있음 | 와이파이_있음 | 조용함 | 24시간 | 시간제한없음 | 노트북_허용 | 혼잡도_낮음
```
